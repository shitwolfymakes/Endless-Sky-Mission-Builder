...
class NPCFrame(ttk.Frame):
    ...
    def __init__(self, master, name, populating=False):
        ...
        self.master.npc_frame_list.append(self)

        edit_button = ttk.Button(self.frame, text="edit", width=3, command=partial(self.master.edit_item, self))
        edit_button.grid(row=0, column=1)

        delete_button = ttk.Button(self.frame, text="X", width=0, command=partial(self.master.delete_item, self))
